tasks-js-frontend is a basic todo list that allows users to create and delete tasks.  The front end is entirely through javascript and the tasks are stored in a separate a rails api directory.  
